        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Name:</strong>
                    <input type="text" name="name" value="{{ $accommodation->name }}" class="form-control" placeholder="Name">
                </div>
            </div>
...
0                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="address" placeholder="Address">{{ $accommodation->address }}</textarea>
                </div>
            </div>
